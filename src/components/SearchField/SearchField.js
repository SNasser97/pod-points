...
const SearchField = ({children, onSearchChange, onSearchSubmit}) => {
	return (
		<div className="SearchField">
			<h2 className="title fs--1">Find what interests you</h2>
			<div className="SearchField__field ">
				<input onChange={ onSearchChange }  type="text" className="SearchField__input fs--3" placeholder="Search for your podcast"/>
			</div>
			<div className="SearchField__field ">
